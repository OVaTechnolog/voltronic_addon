...
### Docker obraz:
#### Tagy
`    docker.io/ondrejva/voltronic-mqtt:0.0.2-x64`  
`    docker.io/ondrejva/voltronic-mqtt:0.0.2-arm32v7`  
`    docker.io/ondrejva/voltronic-mqtt:0.0.2-arm64v8`  
...
`   docker.io/ondrejva/voltronic-mqtt-test:0.0.2-x64`  
`   docker.io/ondrejva/voltronic-mqtt-test:0.0.2-arm32v7`  
`   docker.io/ondrejva/voltronic-mqtt-test:0.0.2-arm64v8`  
